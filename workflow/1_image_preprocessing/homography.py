...
im1 = cv2.imread("../../data/raw/Bridgewater/0_Edinburgh_Nat_Gallery.jpg")    # Image that needs to be registered.
im2 = cv2.imread("../../data/raw/Bridgewater/2_Naples_Museo Capodimonte.jpg") # trainImage
