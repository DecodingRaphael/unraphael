...
image_list = Load_Data().from_folder(['../data/raw/'])
...
# Plot similar images
st.plot_similar_images(image_path=image_list[0], number_of_images=5)
st.plot_similar_images(image_path="../data/raw/0_Edinburgh_Nat_Gallery.jpg", number_of_images=5)
