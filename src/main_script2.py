...
# Object detection (i.e., faces) in the image with detect_objects_haar
...
def extract_features(image, objects, scale_factor =2, canny_threshold1=50, canny_threshold2=150):
    ...
    for (x, y, w, h) in objects:
        ...
        keypoints, descriptors = sift.detectAndCompute(edges, None)
         ...
         # Draw circles at the keypoints' locations on the Canny edges
        ...
        plt.title(f'SIFT Keypoints on Canny Edges for Object: {x, y, w, h}')
        plt.show()
