...
img01 = cv2.imread('images/monkey.jpg', 0)
...
#orb_similarity = orb_sim(img00, img00)  #1.0 means identical. Lower = not similar
...
img1,img2 = Image.open('../data/raw/0_Edinburgh_Nat_Gallery.jpg'), Image.open('../data/raw/Bridgewater/8_London_OrderStJohn.jpg')
